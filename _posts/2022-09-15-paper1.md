...
### Problem Intro
A deep architexture for rectified stereo[^footnote] based on RAFT.
...
[^footnote]: In rectified stereo, the displacement of each pixel is constrained to a horizontal line.